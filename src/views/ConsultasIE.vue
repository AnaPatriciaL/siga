            ...
            <v-row class="mb-4">
              ...
              <v-tooltip top color="pink darken-4">
                <template v-slot:activator="{ on, attrs }">
                  <v-btn class="mt-2"
                    color="pink darken-4" fab dark @click="formNuevo()"
                    v-bind="attrs"
                    v-on="on"
                  >
              ...
              <vue-excel-xlsx v-if="permiso"
                :data="prospectosie_no_localizados"
                :columns="columnas"
                :file-name="'Prospectos IE - NO Localizados'"
                :file-type="'xlsx'"
                :sheet-name="'ProspectosIE-No-Localizados'"
                >
              ...
              <v-card>
                <v-form>
                  <v-card-title class="pink darken-4 white--text py-2"
                    >PROSPECTO DE IMPUESTOS ESTATALES</span>
                    <v-spacer></v-spacer>
                    <span class="text-h6">
...
export default {
  ...
  watch: {
    ...
    'prospectoie.municipio_id'(id_municipio) {      
          console.log('municipio_id changed:', id_municipio, typeof id_municipio);
          console.log(this.municipios_listado);
      if (id_municipio) {
  ...
  methods: {
   ...
   async validar_supervisor() {
    ...
    crear() {
      ...
      let retenedor = this.prospectoie.retenedor;
      let origen = this.prospectoie.origen;
      ...
      console.log ("retenedor:", retenedor );
      ...
      axios.post(crud, 
            {
              ...
              origen:this.prospectoie.origen,
    ...
    formEditar: function (objeto) {
      ...
      this.prospectoie.origen=objeto.origen;
